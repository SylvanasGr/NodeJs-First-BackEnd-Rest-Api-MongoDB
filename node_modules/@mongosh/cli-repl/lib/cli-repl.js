...
const setup_logger_and_telemetry_1 = __importDefault(require("./setup-logger-and-telemetry"));
...
class CliRepl {
    ...
    async start(driverUri, driverOptions) {
        ...
        setup_logger_and_telemetry_1.default(logger.logId, this.bus, () => logger, () => {
            var _a, _b, _c;
        ...
        if (this.config.snippetIndexSourceURLs !== '') {
            snippetManager = new snippet_manager_1.SnippetManager({
    ...
    async connect(driverUri, driverOptions) {
        ...
        const provider = await service_provider_server_1.CliServiceProvider.connect(driverUri, driverOptions, this.cliOptions, this.bus);
