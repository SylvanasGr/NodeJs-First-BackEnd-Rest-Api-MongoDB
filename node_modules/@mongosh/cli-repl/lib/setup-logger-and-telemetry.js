...
function setupLoggerAndTelemetry(logId, bus, makeLogger, makeAnalytics) {
    ...
    log.info('MONGOSH', mongodb_log_writer_1.mongoLogId(1000000000), 'log', 'Starting log', {
    ...
    bus.on('mongosh:driver-initialized', function (driverMetadata) {
        log.info('MONGOSH', mongodb_log_writer_1.mongoLogId(1000000004), 'connect', 'Driver initialized', driverMetadata);
    });
